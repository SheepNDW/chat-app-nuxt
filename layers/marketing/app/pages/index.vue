    ...
    <UContainer class="hero-section">
      <div class="hero-content">
        ...
        <p class="hero-subtitle">
          Experience the future of conversation with our intelligent chat platform. Start meaningful
          conversations powered by cutting-edge AI technology.
        </p>
        <UButton class="text-center font-bold self-center" size="xl" @click="handleCreateChat">
        ...
        <div class="features-grid">
          <div class="feature-card">
            ...
            <p class="feature-description">
              Experience intelligent responses and natural conversation flow with our advanced AI
              technology.
            </p>
          </div>
      ...
      <div class="benefits-content">
        <div class="benefits-text">
          ...
          <p class="benefits-description">
            Our chat platform revolutionizes how you interact with AI. Whether you're seeking
            information, brainstorming ideas, or having casual conversations, we provide an
        ...
        <div class="benefits-image">
          <NuxtImg src="/people.png" alt="Communication Benefits" class="benefits-img" />
        </div>
      </div>
    </UContainer>
    ...
    <UContainer class="cta-section">
      <div class="section-wrapper">
        <div class="cta-content">
          ...
          <UButton class="cta-button" size="xl" variant="outline" @click="handleCreateChat">
            Create A New Chat
          </UButton>
        </div>
      </div>
